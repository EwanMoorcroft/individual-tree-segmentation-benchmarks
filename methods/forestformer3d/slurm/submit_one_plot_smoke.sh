...
EXPECTED_FILES="$RUN_ROOT/staged_input/input_manifest.json|$RUN_ROOT/staged_input/input_preparation.complete|$RUN_ROOT/raw/reference/forestformer3d_smoke_test_final_results.ply|$RUN_ROOT/raw/dummy/forestformer3d_smoke_test_final_results.ply|$RUN_ROOT/validation/smoke_validation.json|$RUN_ROOT/validation/forestformer3d_smoke_predictions.npz|$RUN_ROOT/validation/smoke_validation.complete|$RUN_ROOT/artifact_sha256.txt|$RUN_ROOT/one_plot_smoke.complete"
