"""Inspect FOR-instance LAS files and write aggregate inventory metadata."""
...
def inspect_las(
    ...
    """Return public-safe field, count and extent metadata for one LAS file."""
...
def write_inventory(records: list[dict[str, Any]], csv_path: Path, json_path: Path) -> None:
    """Write the inventory records and aggregate counts as CSV and JSON."""
