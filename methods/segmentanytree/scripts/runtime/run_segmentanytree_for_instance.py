"""Prepare or dry-run one SegmentAnyTree FOR-instance inference task."""
...
DATA_DIR = ROOT / "methods/segmentanytree/scripts/data"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        default="methods/segmentanytree/configs/for_instance_benchmark.yml",
    )
...
def main() -> int:
    """Resolve one plot, prepare managed paths and run or print its command."""
