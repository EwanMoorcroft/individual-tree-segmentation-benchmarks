"""Create a TreeX test evaluation list."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create a TreeX test evaluation list."
    )
    parser.add_argument("--input-csv", required=True)
    parser.add_argument("--output-csv", required=True)
    parser.add_argument(
        "--prediction-root",
        default="data/predictions/treex/for_instance_test",
    )
    parser.add_argument(
        "--results-root",
        ...
        output_rows.append(
            {
                ...
                "summary_json": (
                    f"{args.results_root}/{safe_plot_id}_treex_test_summary.json"
                ),
                "prediction_npz": (
